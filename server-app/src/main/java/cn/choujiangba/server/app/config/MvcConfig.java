package cn.choujiangba.server.app.config;

import java.util.List;

import cn.choujiangba.server.app.interceptor.CROSInterceptor;
...
@ComponentScan(basePackages = "cn.choujiangba.server.app")
@EnableWebMvc
